...
dataset_path=os.path.abspath(os.path.join(BASE_DIR, '../datasets/shapenet_part/shapenetcore_partanno_segmentation_benchmark_v0/'))
#dataset_path=os.path.abspath(os.path.join(BASE_DIR, '../dataset/shapenet_part_Airplane50/'))
...
#            point_set, seg, cls= self.cache[index]
            ...
            fn = self.datapath[index]                 #  所有文件，随机取一个文件数据格式
...
if __name__ == '__main__':
    dset = PartDataset( root='./datasets/shapenetcore_partanno_segmentation_benchmark_v0/',classification=True, class_choice=None, npoints=4096, split='train')
