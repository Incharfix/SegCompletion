...
# 目标： 计算两点间距离
# 是为了做 丢失的数据（和初始点最近的那些点），放入网络中进行训练
# p2是中心点
# p1： 1024个点中的1个点，到92的距离
...
def get_farthest_point(temptensor, tempnumber,RAN = True):
    real_center_key2_idx = farthest_point_sample(temptensor, tempnumber, RAN)
    drop_point_key2 =    index_points(temptensor, real_center_key2_idx)
    return drop_point_key2
