...
class GradientPenalty:
    ...
    """
    gradient 斜坡，坡度 斜率；； Penalty 处罚，刑罚；
        计算梯度惩罚 as defined in "Improved Training of Wasserstein GANs"
        batchSize ():用于训练的批大小。必须更新w.r.t当前批尺寸
        lambdaGP():文中定义的梯度惩罚系数
        Gamma():梯度惩罚的正则化项，增强以最小化“幽灵”
    """
